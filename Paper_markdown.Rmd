...
output:
  pdf_document:
    ...
    template: svm-latex-ms2.tex.url
...
dwplot(MID_Full_Log, show_intercept=TRUE, model_name = "Logistic Model", vline=geom_vline(xintercept=0), dot_args = list(size=3))
exp(coef(MID_Full_Log))

margins(MID_Full_Log)
margins(MID_Full_Log, at = list(US_Naval_Cap = 0:1))
